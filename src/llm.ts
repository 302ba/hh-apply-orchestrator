...
1. Короткое вступление: почему кандидат подходит для этой позиции или что его в ней привлекает. Не начинай с «Откликаюсь на», «Пишу по поводу» или подобных шаблонных формул — начни сразу с сути.
